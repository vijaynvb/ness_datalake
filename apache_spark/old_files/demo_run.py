...
raw_bookings = spark.read.parquet("/app/data/green_tripdata_2024-05.parquet")

# Load location dimension data
dim_location = spark.read.csv("/app/data/dim_location.csv", header=True, inferSchema=True)
