...
# Constants (populated in main() once boto3/STS is reachable)
C_AWS_ACCOUNT_ID = None
C_RAW_BOOKINGS_S3_PATH = None
C_EXCHANGE_RATE_S3_PATH = None
C_FACT_BOOKINGS_S3_PATH = None
C_FACT_BOOKINGS_STAGING_S3_PATH = None
C_GOLD_LAYER_S3_BUCKET = None


def init_s3_paths():
    global C_AWS_ACCOUNT_ID, C_RAW_BOOKINGS_S3_PATH, C_EXCHANGE_RATE_S3_PATH
    global C_FACT_BOOKINGS_S3_PATH, C_FACT_BOOKINGS_STAGING_S3_PATH, C_GOLD_LAYER_S3_BUCKET
