...
output "silver_layer_uri" {
  description = "Example S3 URI prefix for Silver raw data, e.g. transport/bookings/year=2024/month=12/day=02/hour=00/"
  value       = try("s3://${aws_s3_bucket.layer["silver"].id}/", null)
}

output "gold_layer_uri" {
  description = "Example S3 URI prefix for Gold curated data, e.g. datawarehouse/fact_bookings/year=2024/month=12/day=02/"
